    ...
    >
      <div className='block w-5 absolute left-6 top-1/2   transform  -translate-x-1/2 -translate-y-1/2'>
        <span
          ...
          } block absolute h-0.5 w-7 text-orange-500 bg-current transform transition duration-500 ease-in-out`}
        />
        <span
          className={`${
            open && 'opacity-0'
          }  absolute  h-0.5 w-5 block text-orange-500 bg-current transform transition duration-500 ease-in-out`}
        />
        <span
          className={`${
            open ? '-rotate-45' : 'translate-y-1.5'
